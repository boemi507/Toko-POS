                    ...
                    <v-row>
                        ...
                        <v-col cols="12" sm="7" md="7" <?php if ($posPosition == 'left') { ?>order="first" <?php } else { ?>order="last" <?php } ?>>
                            <v-card flat :height="height">
                                ...
                                <v-text-field v-model="scan" prepend-inner-icon="mdi-magnify" placeholder="Scan Barcode/SKU (F4)" label="" v-on:keydown.enter="scanBarang" class="mb-3" solo hide-details clearable autofocus :autofocus="'autofocus'" ref="inputRef"></v-text-field>
