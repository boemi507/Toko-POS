    ...
    <v-row justify="center">
        <v-dialog v-model="kasir" fullscreen hide-overlay transition="dialog-bottom-transition" scrollable persistent>
                    ...
                    <v-row>
                        ...
                        <v-col cols="12" sm="7" md="7" <?php if ($posPosition == 'left') { ?>order="first" <?php } else { ?>order="last" <?php } ?>>
                            <v-card flat :height="height">
                                ...
                                <v-text-field v-model="scan" prepend-inner-icon="mdi-magnify" placeholder="Scan Barcode/SKU (F4)" label="" class="mb-3" solo hide-details clearable @click:clear="clearScanner" autofocus :autofocus="'autofocus'" append-icon="mdi-camera" @click:append="dialogCameraOpen" ref="inputRef"></v-text-field>
                                <v-btn color="primary" @click="scanBarang" class="mb-3" v-if="scan != '' && camera != false"><v-icon>mdi-cart-arrow-down</v-icon></v-btn>
                                <v-btn color="primary" @click="scanBarang" class="mb-3" v-else-if="scan != '' && camera == false"><v-icon>mdi-cart-arrow-down</v-icon></v-btn>
                                ...
                                <v-data-table :height="height1" :headers="tbkeranjang" :fixed-header="true" :items="dataKeranjang" :items-per-page="-1" item-key="id_keranjang" :loading="loading" loading-text="<?= lang('App.loadingWait'); ?>" :footer-props="{itemsPerPageText: ''}" style="overflow-y: auto;">
                                    <template v-slot:item="{ item }">
                                        <tr>
                                            ...
                                            <td width="25%">
                                                <v-text-field v-model="item.qty" type="number" @input="setJumlah(item)" min="0" single-line style="font-size: 1rem;min-width: 85px;"></v-text-field>
                                            </td>
            ...
            <v-footer padless fixed>
                <v-btn x-large block class="text-h5 font-weight-medium" color="success" @click="savePenjualan" title="<?= lang('App.pay') ?>" :loading="loading1" :disabled="keranjang == '' ? true:false">
