                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="v-input__control">
                                        <div class="v-input__slot">
                                            <input class="v-input--selection-controls__input" type="checkbox" name="permission[]" id="menuMaster" value="menuMaster" <?php if ($permissions) { ?><?php if (in_array('menuMaster', $permissions)) { ?><?= "checked"; ?><?php } ?><?php } ?>><label for="menuMaster"></label>
                                        </div>
                                    </div>
                                </td>
                            </tr>
