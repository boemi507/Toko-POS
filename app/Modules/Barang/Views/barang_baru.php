                    ...
                    <v-col cols="12" md="9">
                        <v-row>
                            <v-col cols="12" sm="6" class="mb-n3">
                                <v-text-field label="Barcode" v-model="barcode" :error-messages="barcodeError" append-icon="mdi-camera" @click:append="dialogCameraOpen" ref="inputRef" outlined dense></v-text-field>
                            </v-col>
                            <v-col cols="12" sm="6">
