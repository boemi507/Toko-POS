            ...
            <v-card>
                ...
                <v-card-text class="py-3">
                    <v-form ref="form" v-model="valid">
                        ...
                        <div v-else-if="variableEdit == 'nav_position'">
                            <v-select v-model="valueEdit" :items="dataNavPosition" label="" item-text="text" item-value="value" :error-messages="value_settingError" outlined>
                            </v-select>
                        </div>
